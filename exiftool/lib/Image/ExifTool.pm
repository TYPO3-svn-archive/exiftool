...
@fileTypes = qw(JPEG CRW TIFF GIF MRW RAF X3F JP2 PNG MIE MIFF PS PDF PSD XMP
                ...
                ICC ITC HTML VRD QTIF FPX PICT ZIP RWZ EXE MP3 DICM RAW);
...
# lookup for user lenses defined in @Image::ExifTool::UserDefined::myLenses
...
unless ($Image::ExifTool::noConfig) {
    ...
    if (-r $file) {
        ...
        if (@Image::ExifTool::UserDefined::myLenses) {
            foreach (@Image::ExifTool::UserDefined::myLenses) {
